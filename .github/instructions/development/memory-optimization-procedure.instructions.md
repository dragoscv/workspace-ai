...
const planTest = await mcp_memorymcpserv_search_nodes({
  query: "plan task_list"
});

// Test prompt and instructions search  
const promptTest = await mcp_memorymcpserv_search_nodes({
  query: "prompt user_instructions"
});

// Test task progress search
const progressTest = await mcp_memorymcpserv_search_nodes({
