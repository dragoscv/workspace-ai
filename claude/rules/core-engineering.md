...
- **Small vertical slices**: break work into 2â€“6 hour deliverable increments that ship end-to-end value
...
- **Deployment strategy**: canary â†’ staged â†’ full rollout; always have rollback capability
